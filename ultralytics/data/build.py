...
from .dataset import DAMODataset, YOLODataset, PPDataset, OMDataset
from .multi_dataset import MultiYOLODataset
...
def build_om_dataset(cfg, img_path, batch, data, mode='train', rect=False, stride=32):
    return OMDataset(
        img_path=img_path,
        imgsz=cfg.imgsz,
        batch_size=batch,
